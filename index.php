...
<html>
  ...
  <!-- 
					...
					<ul>
						...
						<li class="has-dropdown">
							...
							<ul class="dropdown">
								...
								<li><a href="pricing.php">Promotion Plans</a></li>
	...
	<header id="gtco-header" class="gtco-cover" role="banner" style="background-image: url(images/planetakeoff.jpg)">
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Welcome to Twist Airlines</span>
							<h1>Experience the twisting power. WE twist you there.</h1>	
						</div>
	...
	<div id="gtco-products">
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2>Gallery</h2>
					<p>there you go, start the experience now.</p>
				</div>
			</div>
			<div class="row">
				<div class="owl-carousel owl-carousel-carousel">
					<div class="item">
						<a href="#"><img src="images/resort1.jpg" alt=""></a>
					</div>
                    
					<div class="item">
						<a href="#"><img src="images/pilotss.jpg" alt=""></a>
					</div>
					<div class="item">
						<a href="#"><img src="images/PURPLE HOSTESS.jpg" alt="PURPLE HOSTESS"></a>
					</div>
					<div class="item">
						<a href="#"><img src="images/waitingroom.jpg" alt=""></a>
					</div>
				</div>
			</div>
		</div>
