...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image:url(images/office.jpg)">
			...
			<div class="row">
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
							<li class="address">12121 Pagmuaswa Close, <br> Monavale HRE 10016</li>
							<li class="phone"><a href="tel://1234567920">+ 263 734 300 522</a></li>
							<li class="email"><a href="mailto:info@yoursite.com">info@TwistAirlines.com</a></li>
